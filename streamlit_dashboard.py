...
def create_original_tab(name: str):
...
@st.cache_data
def create_python_tab(name: str):
    st.header(f"Python {name} dashboard")
    pass

def create_main_tab(name: str, tab):
    tabs_dict = {"excel":
